...
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-SNAPSHOT | 0.0.1-RC4           | Databricks 15.0        | All tests passed                             | chris-twiner | 05.04.24 | sparkutils fork - Using #804/#803 code - requires restart from batch 5 - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible) |
