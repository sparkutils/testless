...
|------------------------------------------------------------|----------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| testless_0.17.0-3.5.1_14.3.dbr_3.5_2.12-0.0.1-SNAPSHOT     | 0.0.1-RC4            | Databricks 15.0 CE     | All tests passed                                                                                                                                                              | chris-twiner | 27.03.24 | Using #804/#803 code - requires restart from batch 5 - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                                       |
...
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC1 | 0.0.1-RC4            | Databricks 15.0 CE     | All tests passed                                                                                                                                                              | chris-twiner | 08.04.24 | sparkutils RC1 fork - Using #804/#803 code - requires restart from batch 5 - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                 |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC4 | 0.0.1-RC4            | Databricks 14.3 LTS    | 12 Tests fail, precision and ordering issues                                                                                                                                  | chris-twiner | 10.04.24 | sparkutils RC2 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                                                 |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC5 | 0.0.1-RC4            | Databricks 14.3 LTS    | 8 Test fails, precision issues                                                                                                                                                | chris-twiner | 11.04.24 | sparkutils RC3 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                                                 |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC6 | 0.0.1-RC4            | Databricks 14.3 LTS    | All tests passed, PivotTest "X4[Boolean, String, Int, Boolean] pivot on String" has ordering issues needs to be re-run                                                        | chris-twiner | 12.04.24 | sparkutils RC4 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                                                 |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC6 | 0.0.1-RC4            | Databricks 15.0        | 3 Tests fail, Aggregate first/last and NonAggregate levenshtein fail (*) PivotTest "X4[Boolean, String, Int, Boolean] pivot on String" has ordering issues needs to be re-run | chris-twiner | 12.04.24 | sparkutils RC4 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible).  (*) first/last fail on List("") == List("") which doesn't make sense - levenshtein also fails |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC8 | 0.0.1-RC4            | Databricks 14.3 LTS    | All tests passed                                                                                                                                                              | chris-twiner | 12.04.24 | sparkutils RC5 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                                                                                 |
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC8 | 0.0.1-RC4            | Databricks 15.0        | All tests passed                                                                                                                                                              | chris-twiner | 12.04.24 | sparkutils RC5 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible).                                                                                                |
