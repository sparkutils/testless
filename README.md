...
| testless_sparkutils_0.17.0-3.5_14.3.dbr_3.5_2.12-0.0.1-RC4 | 0.0.1-RC4           | Databricks 15.0     | 12 Tests fail, precision and ordering issues | chris-twiner | 10.04.24 | sparkutils RC2 fork - Using #804/#803 code - use config 'spark.databricks.driver.dbfsLibraryInstallationAllowed true' before starting to get the jar working (workspace files are not possible)                                 |
